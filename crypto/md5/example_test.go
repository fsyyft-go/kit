...
func Example() {
	...
	hash := kitmd5.HashStringWithoutError("hello world")
	fmt.Println(hash)
...
func ExampleHashString() {
	...
	hash, err := kitmd5.HashString("hello world")
	if err != nil {
...
func ExampleHashStringWithoutError_empty() {
	...
	hash := kitmd5.HashStringWithoutError("")
	fmt.Println(hash)
...
func ExampleHashString_chinese() {
	...
	hash, err := kitmd5.HashString("你好，世界")
	if err != nil {
		fmt.Printf("计算哈希值时发生错误: %v\n", err)
		return
	}
